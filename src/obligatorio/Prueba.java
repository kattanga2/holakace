...
public class Prueba extends Sistema {
    ...
    public static int DatoValido(int min, int max){  //Método que pide un dato y lo verifica entre dos valores a seleccionar.
    ...
    public static String pedirString(){ //Método para pedir String y no crear Scanner en cada método
        Scanner in = new Scanner (System.in);
        String dato = in.nextLine();
        return dato;
    }
  
    public static void modificarSocio(Socio socioMod){ //Método para modificar dirección y edad de un socio
        
        System.out.println("Se modificarán los datos del socio " + socioMod.getNombre());
        System.out.println("Dirección actual: " + socioMod.getDireccion());
    ...
    public static void mostrarOpciones(){ // metodo para desplegar el menu principal
        System.out.println(  "╔═══════════════════════════════════╗"
                         ...
                         + "\n║3- Listado de inscripciones en orden de hora.          ║"
                         + "\n║4- Actualizacion de hora de Actividad.                 ║"
                         + "\n║5- Mostrar datos.                                      ║"
                         + "\n║6- Salir.                                              ║"
                         + "\n╚═══════════════════════════════════╝");
    }
    ...
    public static void main(String[] args) {        
       ...
       // Actividad act = crearActividad();
        ...
        mostrarOpciones();
        System.out.print("Ingresar opción del menú: ");
        ...
        while (opcion != 10){ //pedir que se ingrese opcion del menu hasta que sea = a 6 y termine el programa
            switch (opcion){
                ...
                case 5:
                    System.out.println("Eligió opción 4: Actualizar datos de socio");
                    ...
                    System.out.println("Datos de socio actualizados, presione Enter para volver al menú principal"); 
                    pedirString();
                    mostrarOpciones();
                    opcion = in.nextInt();
                ...
                case 6:
                    System.out.println("Eligió opción 5: Inscripción a una actividad.");
                    
                    
                    System.out.println("Se registró la inscripción a la actividad, presione Enter para volver al menú principal");
                    pedirString();
                    mostrarOpciones();
                    opcion = in.nextInt();
                    break;
                ...
                case 7:
                    ...
                    if (act.getHayInscriptos()){  //Si no hay inscriptos en la actividad muestra que no hay inscripciones para mostrar.
                        ...
                        if (ins1esTemp && ins2esTemp){
                            ...
                            if (ins1esTemp){
                                System.out.println("La inscripción del socio 1 es temprana");    
                            }
                            if (ins2esTemp){
                                System.out.println("La inscripción del socio 2 es temprana"); 
                            }
                            else {
                        ...
                        System.out.println("No hay ninguna inscripción para mostrar.");
                    }

                    System.out.println("");
                    System.out.println("Se desplego la lista de todas las inscripciones, presione Enter para volver al menú principal");
                    pedirString();
                    mostrarOpciones();
                    opcion = in.nextInt();
                    break;
                ...
                case 8:
                    System.out.println("Eligió opción 7: Actualizar hora de actividad");
                    ...
                    System.out.println("Se actualizó la hora de la actividad y la hora de pasar a buscar a los socios, presione Enter para volver al menú principal");
                    pedirString();
                    mostrarOpciones();
                    opcion = in.nextInt();
                    break;
                ...
                case 9:
                    System.out.println("Eligió opción 9: Mostrar todos los datos");
                    ...
                    System.out.println("Datos Inscripción del socio 1");
                    System.out.println(ins1);
                    System.out.println("Datos Inscripción del socio 2");
                    System.out.println(ins2);
                    }
                    else {
                    ...
                    System.out.println("Se desplegaron todos los datos existentes, presione Enter para volver al menú principal");
                    pedirString();
                    mostrarOpciones();
                    opcion = in.nextInt();
                    break;
        ...
        System.out.println("Eligió opción 6: Salir del programa");
        System.out.println("");
